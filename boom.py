...
def banner():
	print(f'''{red}
			...
			▒░▒   ░   ░ ▒ ▒░   ░ ▒ ▒░ ░  ░      ░
			 ░    ░ ░ ░ ░ ▒  ░ ░ ░ ▒  ░      ░   
			 ░          ░ ░      ░ ░         ░                                 
                   {white}[{purple}Facebook : Woraphog Verysleepy{white}]
''')
os.system("clear")
banner()
print(' ')
print(f'{white}[ {red}√{white} ] {green}Versions : {blue1}1.0.0')
print(f'{white}[ {red}#{white} ] {green}Script   : {blue1}sms & call')
print(f'{white}[ {red}?{white} ] {green}Script   : {blue1}FREE')
print(f'{white}[ {red}¥{white} ] {green}Author   : {blue1}Ang')
print(' ')
print('''\033[1;90m----------------------------------------------------------------------
